 ...
 *
 *  Original source: https://github.com/gedanziger/nrlwallet-android-sdk
 *  You can contact the authors via github issues.
 */

package module.nrlwallet.com.bip39;

import io.github.novacrypto.toruntime.CheckedExceptionToRuntime;

import java.util.Arrays;

import static module.nrlwallet.com.bip39.Normalization.normalizeNFKD;
...
public final class SeedCalculator {
     ...
     * https://github.com/gedanziger/nrlwallet-android-sdk/issues/7
     * <p>
     ...
     * @return a seed for HD wallet generation
     */
    public byte[] mnemonicToSeed(final String mnemonic, final String passphrase) {
        final char[] chars = normalizeNFKD(mnemonic).toCharArray();
        try {
            return calculateSeed(chars, passphrase);
        } finally {
