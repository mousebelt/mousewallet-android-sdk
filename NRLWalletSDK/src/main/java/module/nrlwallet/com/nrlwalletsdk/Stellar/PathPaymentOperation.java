...
import module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.PathPaymentOp;
...
public class PathPaymentOperation extends Operation {
  ...
  module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation.OperationBody toOperationBody() {
    ...
    // path
    module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Asset[] path = new module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Asset[this.path.length];
