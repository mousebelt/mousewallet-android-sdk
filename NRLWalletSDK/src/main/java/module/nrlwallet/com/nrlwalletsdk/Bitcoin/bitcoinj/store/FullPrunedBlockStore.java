...
public interface FullPrunedBlockStore extends BlockStore, UTXOProvider {
    ...
    /**
     * Gets a {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.UTXO} with the given hash and index, or null if none is found
     */
    UTXO getTransactionOutput(Sha256Hash hash, long index) throws BlockStoreException;
    
    /**
     * Adds a {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.UTXO} to the list of unspent TransactionOutputs
     */
    void addUnspentTransactionOutput(UTXO out) throws BlockStoreException;
    
    /**
     * Removes a {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.UTXO} from the list of unspent TransactionOutputs
