...
import module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.ChangeTrustOp;
...
public class ChangeTrustOperation extends Operation {
  ...
  module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation.OperationBody toOperationBody() {
    ...
    limit.setInt64(toXdrAmount(this.limit));
    op.setLimit(limit);
  ...
  public static class Builder {
    ...
    Builder(ChangeTrustOp op) {
      ...
      limit = fromXdrAmount(op.getLimit().getInt64().longValue());
    }
