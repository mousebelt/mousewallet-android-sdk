...
/**
 * <p>A KeyChainGroup is used by the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
