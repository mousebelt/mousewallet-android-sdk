...
package module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoin.paymentchannel.Protos;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelCloseException.CloseReason)}
    ...
    interface ClientConnection {
         ...
         * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * will be closed with a  {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelCloseException.CloseReason#TIME_WINDOW_UNACCEPTABLE}.</p>
         ...
         * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelClient#incrementPayment(Coin)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.protocols.channels.PaymentChannelClient}
