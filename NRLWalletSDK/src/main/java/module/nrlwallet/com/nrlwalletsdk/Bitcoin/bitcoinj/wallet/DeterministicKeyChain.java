 ...
 * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.MnemonicCode},
 ...
 * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicKey#serializePubB58(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicKey#deserializeB58(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicKey, String, module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicHierarchy} and
 * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.DeterministicKey)}
     ...
     * @see module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.MarriedKeyChain
     */
