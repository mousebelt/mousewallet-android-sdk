...
import module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Int32;
...
public class Price {
     ...
     */
    public module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Price toXdr() {
        module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Price xdr = new module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Price();
        Int32 n = new Int32();
        Int32 d = new Int32();
        n.setInt32(this.n);
        d.setInt32(this.d);
