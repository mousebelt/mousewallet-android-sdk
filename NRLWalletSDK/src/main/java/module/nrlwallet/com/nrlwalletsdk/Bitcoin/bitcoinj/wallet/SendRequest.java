...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoin.protocols.payments.Protos.PaymentDetails;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
