...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoin.protocols.payments.Protos.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.listeners.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.AbstractBlockChain;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.BloomFilter;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Message;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.PeerFilterProvider;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.PeerGroup;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.ScriptException;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionBag;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.UTXOProvider;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.UTXOProviderException;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Utils;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.VarInt;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.VerificationException;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionConfidence.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.script.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.signers.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.utils.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.Protos.Wallet.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.WalletTransaction.*;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.KeyChainEventListener;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.ScriptsChangeEventListener;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.WalletChangeEventListener;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.WalletCoinsSentEventListener;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.WalletEventListener;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.KeyCrypter,
     ...
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
