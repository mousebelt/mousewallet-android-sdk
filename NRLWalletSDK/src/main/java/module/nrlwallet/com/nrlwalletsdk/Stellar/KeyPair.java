...
public class KeyPair {
  ...
  private static final EdDSANamedCurveSpec ed25519 = EdDSANamedCurveTable.getByName("ed25519");//("ed25519-sha-512");
  ...
  public DecoratedSignature signDecorated(byte[] data) {
    ...
    module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Signature signature = new module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Signature();
