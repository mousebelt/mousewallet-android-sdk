...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionConfidence.ConfidenceType;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.crypto.TransactionSignature;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.script.Script;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.script.ScriptBuilder;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.script.ScriptOpCodes;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.signers.TransactionSigner;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.utils.ExchangeRate;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.Wallet;
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.WalletTransaction.Pool;
...
import static module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Utils.*;
...
public class Transaction extends ChildMessage {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.script.Script, ECKey, module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TxConfidenceTable}
