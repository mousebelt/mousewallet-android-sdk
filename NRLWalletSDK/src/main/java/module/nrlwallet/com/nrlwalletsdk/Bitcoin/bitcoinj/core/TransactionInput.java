...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.DefaultRiskAnalysis;
...
public class TransactionInput extends ChildMessage {
     ...
     * @see TransactionOutPoint#getConnectedRedeemData(module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.KeyBag)
     */
    @Nullable
