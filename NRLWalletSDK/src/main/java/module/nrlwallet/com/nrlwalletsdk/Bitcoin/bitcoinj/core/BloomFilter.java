...
public class BloomFilter extends Message {
     ...
     * See {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    /**
     * Returns true if this filter will match anything. See {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.BloomFilter#setMatchAll()}
