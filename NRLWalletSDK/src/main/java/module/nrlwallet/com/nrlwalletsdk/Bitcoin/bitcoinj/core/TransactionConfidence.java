 ...
 *
 * <p>TransactionConfidence is updated via the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.wallet.CoinSelector} implementations to risk analyze
