...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.orchid.*;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.net.*;
...
import module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.utils.Threading;
...
//                httpClient.setSocketFactory(torClient.getSocketFactory());
     ...
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.bitcoinj.core.Peer#ping()}.
     */
    ...
    /**
     * Returns the {@link module.nrlwallet.com.nrlwalletsdk.Bitcoin.orchid.TorClient} object for this peer group, if Tor is in use, null otherwise.
     */
    @Nullable
