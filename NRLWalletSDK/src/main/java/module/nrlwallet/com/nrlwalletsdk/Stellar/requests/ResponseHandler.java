...
import module.nrlwallet.com.nrlwalletsdk.Stellar.responses.TypedResponse;
...
public class ResponseHandler<T> {
  ...
  public T handleResponse(final Response response) throws IOException, TooManyRequestsException {
    try {
      ...
      if (object instanceof module.nrlwallet.com.nrlwalletsdk.Stellar.responses.Response) {
        ((module.nrlwallet.com.nrlwalletsdk.Stellar.responses.Response) object).setHeaders(response.headers());
      }
