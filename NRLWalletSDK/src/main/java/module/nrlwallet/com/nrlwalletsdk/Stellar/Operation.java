...
public abstract class Operation {
   ...
   */
  public module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation toXdr() {
    module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation xdr = new module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation();
  ...
  public String toXdrBase64() {
    try {
      module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation operation = this.toXdr();
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation.encode(xdrOutputStream, operation);
   ...
   */
  public static Operation fromXdr(module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation xdr) {
    module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation.OperationBody body = xdr.getBody();
    Operation operation;
   ...
   */
  abstract module.nrlwallet.com.nrlwalletsdk.Stellar.xdr.Operation.OperationBody toOperationBody();
}
